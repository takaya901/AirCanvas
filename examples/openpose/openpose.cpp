...
// Display
DEFINE_bool(fullscreen,                 true,          "Run in full-screen mode (press f during runtime to toggle).");
...
int main(int argc, char *argv[])
{
	...
	////画像読み込み
	//transImg = cv::imread("examples/media/z.png", cv::IMREAD_UNCHANGED);
	//baseImg = cv::imread("examples/media/lena.jpg");
